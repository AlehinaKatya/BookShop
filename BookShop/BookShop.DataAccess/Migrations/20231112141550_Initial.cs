        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonalisedDiscount = table.Column<int>(type: "int", nullable: false),
                    ExternalId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModificationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_points_of_delivery", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_products_publishing_houses_PublishingHouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_characteristics_genres_GenreId",
                        column: x => x.GenreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_product_author", x => x.Id);
                    table.ForeignKey(
                        name: "FK_product_author_authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_product_author_products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_shopping_baskets_customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_shopping_baskets_products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointOfDeliveryId = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ExternalId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModificationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orders_points_of_delivery_PointOfDeliveryId",
                        column: x => x.PointOfDeliveryId,
                        principalTable: "points_of_delivery",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_orders_shopping_baskets_ShoppingBasketId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_characteristics_GenreId",
                table: "characteristics",
                column: "GenreId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_orders_PointOfDeliveryId",
                table: "orders",
                column: "PointOfDeliveryId");

            migrationBuilder.CreateIndex(
                name: "IX_orders_ShoppingBasketId",
                table: "orders",
                column: "ShoppingBasketId");

            migrationBuilder.CreateIndex(
                name: "IX_points_of_delivery_ExternalId",
                table: "points_of_delivery",
                column: "ExternalId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_product_author_AuthorId",
                table: "product_author",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_product_author_ExternalId",
                table: "product_author",
                column: "ExternalId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_product_author_ProductId",
                table: "product_author",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_publishing_houses_ExternalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_shopping_baskets_CustomerId",
                table: "shopping_baskets",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_shopping_baskets_ExternalId",
                table: "shopping_baskets",
                column: "ExternalId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_shopping_baskets_ProductId",
                table: "shopping_baskets",
                column: "ProductId");
        }
