    ...
    public class CustomerRepositoryTests : RepositoryTestsBaseClass
    {
        ...
        public void GetAllCustomersTest()
        {
            ...
            new CustomerEntity()
            {
                ...
                Email = "Test2",
                PasswordHash = "Test2",
                DateOfBith = new DateTime(2003, 3, 13),
                PersonalisedDiscount = 10,
                ExternalId = Guid.NewGuid()
            }
            };
            ...
            //assert        
            actualCustomers.Should().BeEquivalentTo(customers, options => options.Excluding(x => x.PersonalisedDiscount)
                .Excluding(x => x.Patronymic));
        }
        ...
        public void GetAllCustomersWithFilterTest()
        {
            ...
            actualCustomers.Should().BeEquivalentTo(customers.Where(x => x.Surname == "Test2"),
                options => options.Excluding(x => x.PersonalisedDiscount)
                .Excluding(x => x.Patronymic));
        }
        ...
        public void SaveNewCustomersTest()
        {
            ...
            actualCustomer.Should().BeEquivalentTo(customer, options => options.Excluding(x => x.PersonalisedDiscount)
                .Excluding(x => x.Patronymic)
                .Excluding(x => x.Id)
